 ...
 * 2017-08-02T12:30:39.078+02:00
 * Generated source version: 3.1.11
 * 
 */
@WebServiceClient(name = "isiPartnerService", 
                  wsdlLocation = "classpath:ISIPartnerEndpoint.wsdl",
...
public class IsiPartnerService extends Service {
    ...
    static {
        URL url = IsiPartnerService.class.getClassLoader().getResource("ISIPartnerEndpoint.wsdl");
        if (url == null) {
            java.util.logging.Logger.getLogger(IsiPartnerService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "classpath:ISIPartnerEndpoint.wsdl");
        }       
        WSDL_LOCATION = url;   
    }
